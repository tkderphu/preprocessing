...
| Service | Port | Endpoint | Phương thức | Mô tả/Chức năng chính |
| --- | --- | --- | --- | --- |
| Customer | 8001 | /api/customers/ | GET, POST | Quản lý danh sách khách hàng |
| Customer | 8001 | /api/customers/{id}/ | GET, PUT, DELETE | Chi tiết/Cập nhật/Xóa khách hàng |
| Customer | 8001 | /api/login/ | POST | Đăng nhập hệ thống |
| Book | 8003 | /api/books/ | GET | Lấy danh sách sách |
| Book | 8003 | /api/books/{id}/ | GET | Xem chi tiết sách |
| Cart | 8002 | /api/carts/ | GET, POST | Quản lý giỏ hàng |
| Cart | 8002 | /api/carts/{id}/ | GET, PUT, PATCH, DELETE | Thao tác trên giỏ hàng cụ thể |
| Order | 8007 | /api/orders/checkout/ | POST | Đặt hàng (Checkout) |
| Order | 8007 | /api/orders/customer/{customer_id}/ | GET | Lịch sử đơn hàng của khách |
| Order | 8007 | /api/orders/{order_id}/ | GET | Chi tiết đơn hàng |
| Payment | 8009 | /api/payments/create/ | POST | Tạo thanh toán mới |
| Payment | 8009 | /api/payments/order/{order_id}/ | GET | Kiểm tra thanh toán theo đơn hàng |
| Shipment | 8008 | /api/shipments/create/ | POST | Tạo vận đơn |
| Shipment | 8008 | /api/shipments/order/{order_id}/ | GET | Theo dõi vận chuyển theo đơn hàng |
| Review | 8010 | /api/reviews/ | GET, POST | Quản lý đánh giá |
| Review | 8010 | /api/reviews/book/{book_id}/ | GET | Xem đánh giá theo sách |
| Review | 8010 | /api/reviews/book/{book_id}/avg/ | GET | Điểm đánh giá trung bình |
| Voucher | 8012 | /api/vouchers/ | GET, POST | Quản lý mã giảm giá |
| Voucher | 8012 | /api/vouchers/apply/ | POST | Áp dụng voucher vào đơn hàng |
| Voucher | 8012 | /api/vouchers/validate/ | POST | Kiểm tra tính hợp lệ của mã |

### 3. Tài liệu API
Dịch vụ API Gateway sẽ đóng vai trò là cổng ra vào duy nhất cho hệ thống, và sẽ điều hướng yêu cầu từ khách hàng đến đúng dịch vụ đích.
